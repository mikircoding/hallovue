					...
					<div class="container px-5 py-24 mx-auto">
						<div
							...
							<div class="flex-grow sm:text-left text-center mt-6 sm:mt-0">
								<h1 class="text-black text-2xl title-font font-bold mb-2">Jasa Integrasi dengan Payment Gateway</h1>
								...
								<a class="mt-3 text-indigo-500 inline-flex items-center">Kepoin
			...
			<card class="border-gray-300 border-2 rounded-xl w-[30rem] py-7 px-5">
				<div class="grid grid-cols-6 gap-3">
					...
					<div class="col-span-4">
						...
						<p class="text-gray-500 mt-4"> Meet learners from around the world, build your reputation, and
			...
			<card class="border-gray-300 border-2 rounded-xl w-[30rem] py-7 px-5">
				<div class="grid grid-cols-6 gap-3">
					...
					<div class="col-span-4">
						...
						<p class="text-gray-500 mt-4"> Share your language expertise and help learners have fun, relax,
							and speak confidently </p>
					</div>
			...
			<card class="border-gray-300 border-2 rounded-xl w-[30rem] py-7 px-5">
				<div class="grid grid-cols-6 gap-3">
					...
					<div class="col-span-4">
						...
						<p class="text-gray-500 mt-4"> Enjoy access to Duolingo staff and learning materials, unreleased
							features, and a special profile badge </p>
					</div>
